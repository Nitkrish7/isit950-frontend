...
export default function HotelAdminProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsEditing(false);
      const updatedUser = await userAPI.getProfile(editData.email);
      setUser(updatedUser);
    } catch (err) {
              ...
              {isEditing ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      type="submit"
                      disabled={isLoading}
                      className={`flex items-center gap-2 px-6 py-2 border border-transparent rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-6">
                    <Link
                      href="/reset-password"
                      className="inline-block px-4 py-2 bg-blue-50 text-blue-700 rounded-lg font-medium hover:bg-blue-100 transition-colors"
                    >
                      Reset Password
                    </Link>
                  </div>
